                    ...
                    <div className="space-y-3 mt-6">
                      ...
                      >
                        ...
                        <div className="flex gap-2">
                          ...
                          <a href="https://www.bhanuprakashpeddi.tech/" target="_blank" rel="noopener noreferrer" className="w-8 h-8 bg-cyan-500/10 hover:bg-cyan-500/20 rounded-full flex items-center justify-center transition-colors">
                            <svg className="w-4 h-4 text-cyan-400" fill="currentColor" viewBox="0 0 24 24">
